    ...
    return (
        <div className="fixed inset-0 z-[60] flex items-center justify-center">
            ...
            <div
                ...
                className="relative bg-white dark:bg-neutral-800 rounded-xl w-full max-w-lg mx-4 shadow-xl max-h-[80vh] flex flex-col"
            >
                {/* Header */}
                <div className="flex items-center justify-between p-5 border-b border-gray-100 dark:border-neutral-700">
                    <div>
                        <h3 id="translation-preview-title" className="text-lg font-semibold text-gray-900 dark:text-neutral-100">
                            Translation Preview
                        </h3>
