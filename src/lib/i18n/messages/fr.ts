...
export const fr: Messages = {
    ...
    dm: {
        ...
        // Round 8 — Pagination
        loadMoreMessages: 'Charger les messages plus anciens',
        loadingMoreMessages: 'Chargement…',
        loadMoreConversations: 'Charger plus',
        loadingMoreConversations: 'Chargement…',
    },
    ...
    // CR14 — Bug Reporter (Admin uniquement)
    bugReporter: {
        buttonAriaLabel: 'Signaler un bug',
        modalTitle: 'Signaler un bug',
        fieldTitle: 'Titre',
        fieldTitlePlaceholder: 'Description courte du bug',
        fieldDescription: 'Description',
        fieldDescriptionPlaceholder: 'Étapes pour reproduire, comportement attendu vs observé…',
        fieldPriority: 'Priorité',
        fieldReproducibility: 'Reproductibilité',
        fieldCategory: 'Catégorie',
        fieldPageUrl: 'URL de la page',
        fieldScreenshots: 'Captures d\'écran',
        fieldScreenshotsHint: 'optionnel, max 5',
        priorityP1: 'P1 — Critique',
        priorityP2: 'P2 — Haute',
        priorityP3: 'P3 — Moyenne',
        priorityP4: 'P4 — Basse',
        reproducibilityAlways: 'Toujours',
        reproducibilitySometimes: 'Parfois',
        reproducibilityOnce: 'Une fois',
        submit: 'Soumettre le rapport',
        submitting: 'Envoi en cours…',
        cancel: 'Annuler',
        submitSuccess: 'Rapport envoyé',
        submitError: 'Échec de l\'envoi du rapport',
        screenshotDropHint: 'Déposez des captures, collez (Cmd+V) ou sélectionnez',
        screenshotTypeHint: 'JPEG · PNG · WebP · GIF · max 5 Mo chacun',
        screenshotAtLimit: 'Limite de 5 captures atteinte',
        screenshotUploading: 'Chargement…',
        screenshotTooLarge: 'Capture trop volumineuse — max 5 Mo',
        screenshotInvalidType: 'Uniquement JPEG, PNG, WebP et GIF autorisés',
        screenshotUploadFailed: 'Échec du chargement — veuillez réessayer',
        tablePageTitle: 'Rapports de bugs',
        tablePageSubtitle: 'Trier et suivre les bugs signalés par l\'équipe.',
        tableExportPdf: 'Exporter PDF ↗',
        tableFilterAllStatuses: 'Tous les statuts',
        tableFilterAllPriorities: 'Toutes les priorités',
        tableLoadMore: 'Charger plus',
        tableLoadingMore: 'Chargement…',
        tableEmpty: 'Aucun rapport trouvé',
        tableColPriority: 'Priorité',
        tableColTitle: 'Titre',
        tableColCategory: 'Catégorie',
        tableColUrl: 'URL',
        tableColReported: 'Signalé',
        tableColStatus: 'Statut',
        tableColReporter: 'Rapporteur',
        tableColScreenshots: 'Captures',
        statusOpen: 'Ouvert',
        statusInProgress: 'En cours',
        statusResolved: 'Résolu',
        statusClosed: 'Fermé',
        navLabel: 'Rapports de bugs',
    },
};
